 ...
 */
#define EP_TABLE_RELIC_BASIC		(FP_BITS + 1)

/**
 * Size of a precomputation table using Yao's windowing method.
 */
#define EP_TABLE_RELIC_YAOWI      (FP_BITS / EP_DEPTH + 1)

/**
 * Size of a precomputation table using the NAF windowing method.
 */
#define EP_TABLE_RELIC_NAFWI      (FP_BITS / EP_DEPTH + 1)

/**
 * Size of a precomputation table using the single-table comb method.
 */
#define EP_TABLE_RELIC_COMBS      (1 << EP_DEPTH)

/**
 * Size of a precomputation table using the double-table comb method.
 */
#define EP_TABLE_RELIC_COMBD		(1 << (EP_DEPTH + 1))

/**
 * Size of a precomputation table using the w-(T)NAF method.
 */
#define EP_TABLE_RELIC_LWNAF		(1 << (EP_DEPTH - 2))

/**
 * Size of a precomputation table using the chosen algorithm.
 */
#if EP_FIX == BASIC
#define EP_TABLE_RELIC			EP_TABLE_RELIC_BASIC
#elif EP_FIX == YAOWI
#define EP_TABLE_RELIC			EP_TABLE_RELIC_YAOWI
#elif EP_FIX == NAFWI
#define EP_TABLE_RELIC			EP_TABLE_RELIC_NAFWI
#elif EP_FIX == COMBS
#define EP_TABLE_RELIC			EP_TABLE_RELIC_COMBS
#elif EP_FIX == COMBD
#define EP_TABLE_RELIC			EP_TABLE_RELIC_COMBD
#elif EP_FIX == LWNAF
#define EP_TABLE_RELIC			EP_TABLE_RELIC_LWNAF
#endif
 ...
 */
#ifdef STRIP
#define EP_TABLE_RELIC_MAX EP_TABLE_RELIC
#else
#define EP_TABLE_RELIC_MAX MAX(EP_TABLE_RELIC_BASIC, EP_TABLE_RELIC_COMBD)
#endif
