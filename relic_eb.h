 ...
 */
#define EB_TABLE_RELIC_BASIC		(FB_BITS)

/**
 * Size of a precomputation table using Yao's windowing method.
 */
#define EB_TABLE_RELIC_YAOWI      (FB_BITS / EB_DEPTH + 1)

/**
 * Size of a precomputation table using the NAF windowing method.
 */
#define EB_TABLE_RELIC_NAFWI      (FB_BITS / EB_DEPTH + 1)

/**
 * Size of a precomputation table using the single-table comb method.
 */
#define EB_TABLE_RELIC_COMBS      (1 << EB_DEPTH)

/**
 * Size of a precomputation table using the double-table comb method.
 */
#define EB_TABLE_RELIC_COMBD		(1 << (EB_DEPTH + 1))

/**
 * Size of a precomputation table using the w-(T)NAF method.
 */
#define EB_TABLE_RELIC_LWNAF		(1 << (EB_DEPTH - 2))

/**
 * Size of a precomputation table using the chosen algorithm.
 */
#if EB_FIX == BASIC
#define EB_TABLE_RELIC			EB_TABLE_RELIC_BASIC
#elif EB_FIX == YAOWI
#define EB_TABLE_RELIC			EB_TABLE_RELIC_YAOWI
#elif EB_FIX == NAFWI
#define EB_TABLE_RELIC			EB_TABLE_RELIC_NAFWI
#elif EB_FIX == COMBS
#define EB_TABLE_RELIC			EB_TABLE_RELIC_COMBS
#elif EB_FIX == COMBD
#define EB_TABLE_RELIC			EB_TABLE_RELIC_COMBD
#elif EB_FIX == LWNAF
#define EB_TABLE_RELIC			EB_TABLE_RELIC_LWNAF
#endif
 ...
 */
#ifdef STRIP
#define EB_TABLE_RELIC_MAX 		EB_TABLE_RELIC
#else
#define EB_TABLE_RELIC_MAX 		MAX(EB_TABLE_RELIC_BASIC, EB_TABLE_RELIC_COMBD)
#endif
