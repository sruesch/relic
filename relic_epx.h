 ...
 */
#define EPX_TABLE_RELIC_BASIC		(2 * FP_BITS + 1)

/**
 * Size of a precomputation table using Yao's windowing method.
 */
#define EPX_TABLE_RELIC_YAOWI      (2 * FP_BITS / EP_DEPTH + 1)

/**
 * Size of a precomputation table using the NAF windowing method.
 */
#define EPX_TABLE_RELIC_NAFWI      (2 * FP_BITS / EP_DEPTH + 1)

/**
 * Size of a precomputation table using the single-table comb method.
 */
#define EPX_TABLE_RELIC_COMBS      (1 << EP_DEPTH)

/**
 * Size of a precomputation table using the double-table comb method.
 */
#define EPX_TABLE_RELIC_COMBD		(1 << (EP_DEPTH + 1))

/**
 * Size of a precomputation table using the w-(T)NAF method.
 */
#define EPX_TABLE_RELIC_LWNAF		(1 << (EP_DEPTH - 2))

/**
 * Size of a precomputation table using the chosen algorithm.
 */
#if EP_FIX == BASIC
#define EPX_TABLE_RELIC			EPX_TABLE_RELIC_BASIC
#elif EP_FIX == YAOWI
#define EPX_TABLE_RELIC			EPX_TABLE_RELIC_YAOWI
#elif EP_FIX == NAFWI
#define EPX_TABLE_RELIC			EPX_TABLE_RELIC_NAFWI
#elif EP_FIX == COMBS
#define EPX_TABLE_RELIC			EPX_TABLE_RELIC_COMBS
#elif EP_FIX == COMBD
#define EPX_TABLE_RELIC			EPX_TABLE_RELIC_COMBD
#elif EP_FIX == LWNAF
#define EPX_TABLE_RELIC			EPX_TABLE_RELIC_LWNAF
#endif
 ...
 */
#ifdef STRIP
#define EPX_TABLE_RELIC_MAX EPX_TABLE_RELIC
#else
#define EPX_TABLE_RELIC_MAX MAX(EPX_TABLE_RELIC_BASIC, EPX_TABLE_RELIC_COMBD)
#endif
