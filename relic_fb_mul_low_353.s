...
.macro MULN_TABLE_RELIC
    mov     r1, T_PTR
    FILL_TABLE_RELIC 0, 16 /* fill 17 columns */
...
.macro MULN_TABLE_RELIC_KARATSUBA
    mov     r1, T_PTR
    FILL_TABLE_RELIC 0, 11 /* fill 12 columns */
    sub #2*T_LINE, T_PTR /* restore T_PTR */
    sub #2*T_LINE, B_PTR /* restore B_PTR */
.endm

.macro FILL_TABLE_RELIC i, j
    .if \i == 0
...
fb_muln_low_karatsuba:
    ...
    sub #TABLE_RELIC_SIZE,r1

    MULN_TABLE_RELIC_KARATSUBA

#include "fb_mul_353_ld_k2.inc"

    add #TABLE_RELIC_SIZE,r1
