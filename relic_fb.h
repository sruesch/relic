 ...
 * trivial approach.
 */
#define FB_TABLE_RELIC_BASIC		(1)

/**
 * Size of a precomputation table for repeated squaring/square-root using the
 * faster approach.
 */
#define FB_TABLE_RELIC_QUICK      ((FB_DIGIT / 4) * FB_DIGS * 16)
 ...
 */
#if FB_ITR == BASIC
#define FB_TABLE_RELIC 			FB_TABLE_RELIC_BASIC
#else
#define FB_TABLE_RELIC			FB_TABLE_RELIC_QUICK
#endif
 ...
 */
#ifdef STRIP
#define FB_TABLE_RELIC_MAX 		FB_TABLE_RELIC
#else
#define FB_TABLE_RELIC_MAX 		FB_TABLE_RELIC_QUICK
#endif
